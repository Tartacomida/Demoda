    ...
    <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
        ...
        <div class="w-1/2 pl-2 md:pl-0">
            <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
                <i class="fas fa-sun text-pink-600 pr-3"></i> Demoda A la Moda
            </a>
        </div>
            ...
            <div class="flex relative inline-block float-right">
                ...
                <div class="relative text-sm">
                    <button id="userButton" class="flex items-center focus:outline-none mr-3">
                        <img class="w-8 h-8 rounded-full mr-4" src="http://i.pravatar.cc/300" alt="Avatar of User"> <span class="hidden md:inline-block">Bienvenido</span>
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="/Demoda/public/inventario" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-purple-500">
...
<section
    ...
    <div class="md:flex-1 md:mr-10">
      <h1 class="font-pt-serif text-5xl font-bold mb-7">
        El estilo es cuestión instinto
    ...
    <div class="flex justify-around md:block mt-8 md:mt-0 md:flex-1">
      ...
      <img src='Media/demodaimg.jpg' alt="Macbook" />
      <div class="relative">
    ...
    <div class="container max-w-md mx-auto flex py-8">
        ...
        <div class="w-full mx-auto flex flex-wrap">
            <div class="flex w-full md:w-1/2 ">
                <div class="px-8">
                    <h3 class="font-bold text-gray-900">Terminos y condiciones</h3>
                </div>
            </div>
